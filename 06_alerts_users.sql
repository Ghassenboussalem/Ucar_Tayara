...
'Pic anormal du taux d''abandon au semestre S1 2026',
...
'total_enrolled', 2749.00, 3500.00, FALSE, '2026-09-26 10:05:00', NULL),

(5, 5, 'finance', 'warning',
'Taux d''exécution budgétaire proche de saturation avant clôture',
'Le budget consommé sur l''exercice 2026 atteint déjà un niveau exceptionnellement élevé alors que plusieurs mois administratifs restent à couvrir. Cette cadence de dépense expose l''établissement à un risque de tension de trésorerie sur les engagements de fin d''année. Une priorisation immédiate des dépenses non essentielles est conseillée.',
'budget_execution_rate', 97.80, 95.00, FALSE, '2026-10-18 14:30:00', NULL),

(6, 19, 'finance', 'critical',
'Dépassement budgétaire constaté sur l''exercice 2026',
...
'budget_execution_rate', 108.00, 100.00, FALSE, '2026-11-07 15:10:00', NULL),
...
'research_budget_pct', 0.40, 5.00, FALSE, '2025-10-12 09:40:00', NULL);
INSERT INTO users (id, email, password_hash, full_name, role, institution_id, is_active, created_at) VALUES
(1, 'president@ucar.rnu.tn', '$2b$12$fakehashfordemopurposes', 'Mohamed Salah Ben Aissa', 'presidency', NULL, TRUE, '2025-09-01 08:00:00'),

(2, 'admin.fsegn@ucar.rnu.tn', '$2b$12$fakehashfordemopurposes', 'Amel Trabelsi Ghariani', 'institution_admin', 3, TRUE, '2025-09-05 09:15:00'),
(3, 'admin.enstab@ucar.rnu.tn', '$2b$12$fakehashfordemopurposes', 'Nizar Ben Mahmoud', 'institution_admin', 7, TRUE, '2025-09-05 09:30:00'),
(4, 'admin.essths@ucar.rnu.tn', '$2b$12$fakehashfordemopurposes', 'Sonia Khelifi Jlassi', 'institution_admin', 12, TRUE, '2025-09-05 09:45:00'),

(5, 'viewer.ihec@ucar.rnu.tn', '$2b$12$fakehashfordemopurposes', 'Walid Hichem Charfi', 'viewer', 13, TRUE, '2025-09-10 10:20:00'),
(6, 'viewer.supcom@ucar.rnu.tn', '$2b$12$fakehashfordemopurposes', 'Rim Ben Salem Toumi', 'viewer', 33, TRUE, '2025-09-10 10:35:00');
